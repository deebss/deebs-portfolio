            ...
            <div
                ...
                <div>
                    <h1 className={`${styles.heroHeadText} text-white`}>Hi, I'm <span
                        className={'text-[#915EFF]'}>David</span></h1>
                    <p className={`${styles.heroSubText} mt-2 text-white-100`}>I develop fullstack web<br
                        className={'sm:block hidden'}/> applications & user interfaces</p>
                </div>
            </div>
            <ComputersCanvas/>
